  ...
  return (
    <div className="rsec">
      ...
      <div className="fld">
        ...
        <MultiSelect
          options={ms.body.o}
          selected={ms.body.sel}
          placeholder={ms.body.ph}
          onChange={(sel) => setMsSelection('body', sel)}
        />
      </div>
      <div className="fld">
        ...
        <MultiSelect
          options={ms.equip.o}
          selected={ms.equip.sel}
          placeholder={ms.equip.ph}
          onChange={(sel) => setMsSelection('equip', sel)}
        />
      </div>
      <div className="fld">
        <label>Service type</label>
        <MultiSelect
          options={ms.service.o}
          selected={ms.service.sel}
          placeholder={ms.service.ph}
          onChange={(sel) => setMsSelection('service', sel)}
        />
      </div>
    </div>
  )
